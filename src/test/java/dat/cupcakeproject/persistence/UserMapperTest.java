package dat.cupcakeproject.persistence;

import dat.cupcakeproject.model.entities.User;
import dat.cupcakeproject.model.exceptions.DatabaseException;
import dat.cupcakeproject.model.persistence.ConnectionPool;
import dat.cupcakeproject.model.persistence.UserMapper;
...
class UserMapperTest
{
    ...
    private final static String URL = "jdbc:mysql://localhost:3306/cupcakedb_test?serverTimezone=CET&allowPublicKeyRetrieval=true&useSSL=false";
